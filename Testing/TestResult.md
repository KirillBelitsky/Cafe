...
|008-1: Масштабируемость интерфейса под различные диагонали | 1. Проверить приложение на устройствах с диагональю 4.3-4.5, 4.7-5, 5.2-5.4, 5.5 и более дюймов| Приложение подстраивается под нужную диагональ | Приложение подстраивается под нужную диагональ | Тест пройден |
## Замечания
